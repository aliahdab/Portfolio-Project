  ...
  render() {
    return (
      <section className="home-container">
        <div className='img-container'> <img src={Image} alt="avatar" className="avatar" /></div>
        <div>
